...
- **来源质量硬标准**（命门，宁缺毋滥）：
  - **优先**：顶会 / 期刊实证（**IEEE S&P、USENIX Security、ACM CCS、NeurIPS/ICML/ICLR、PoPETs**、arXiv 预印）；厂商**安全/官方文档**（Apple Security Research、NVIDIA、OpenAI/Anthropic data-retention、CCC）；标准（NIST SP 800-226、OWASP LLM Top 10、GDPR/EU AI Act 条文）。
