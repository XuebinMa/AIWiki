...
- 🟡 **#8 新专题候选**：评审第四轮建议补 code review / db migration / 多 agent 协作 / 成本治理等专题。**已落地批次一「AI 代码审查」子簇 4 条**（自我偏好 / 漏逻辑 / 上下文饥饿 / 审查谄媚 + 橡皮图章，均 `06-testing`、`evidence: 研究支持`，挂机制索引「反馈循环退化 / 目标函数错位 / 全局视野不足」）；db migration / 多 agent 协作 / 成本治理等其余专题待后续批次。
