...
tags: [plan mode, collaboration stance, rework, project manager, engineer, architect]
sources:
...
<PitfallMeta roles={['Project Manager', 'Engineer', 'Architect']} phase="Setup & Collaboration" severity="Medium" appliesTo="All Claude Code versions" />
