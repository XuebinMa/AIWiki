...
sidebar_label: "Skipping plan mode"
...
tags: [plan mode, collaboration stance, rework, project manager, engineer, architect, Gemini CLI, Cursor, GitHub Copilot]
sources:
...
<PitfallMeta roles={['Project Manager', 'Engineer', 'Architect']} phase="Setup & Collaboration" severity="Medium" appliesTo="All coding agents" evidence="Official docs" />
...
flowchart TD
    ...
    E --> F["Tear down, start over<br/>high rework cost"]
