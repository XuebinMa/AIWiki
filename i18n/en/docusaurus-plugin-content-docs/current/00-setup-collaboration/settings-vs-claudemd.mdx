...
tags: [settings.json, CLAUDE.md, permissions, configuration, hook, Engineer, Architect]
sources:
...
<PitfallMeta roles={['Engineer', 'Architect']} phase="Setup & Collaboration" severity="High" appliesTo="All Claude Code versions" />
