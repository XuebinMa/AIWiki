...
<PitfallMeta roles={['Project Manager', 'Engineer', 'Architect']} phase="Setup & Collaboration" severity="High" appliesTo="All models" evidence="Research" />
...
flowchart TD
    ...
    B --> C[review becomes a formality<br/>grip and skills atrophy<br/>&nbsp;]
    C --> D[harder to catch my errors<br/>hidden under the polish<br/>&nbsp;]
