...
<PitfallMeta roles={['Architect', 'Engineer']} phase="Setup & Collaboration" severity="High" appliesTo="All Claude Code versions" evidence="Official docs" />
...
flowchart TB
    ...
    A -.separate contexts, blind to each other.-> X["Mismatch at assembly<br/>field names / interfaces / file conflicts<br/>&nbsp;"]
    B -.-> X
    C -.-> X
```
