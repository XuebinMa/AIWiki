...
tags: [network isolation, egress control, SSRF, data exfiltration, lethal trifecta, security, DevOps Engineer, Architect, Gemini CLI, Codex CLI]
sources:
...
Whichever you use, two constants: **the unit of egress control is "a domain list + who enforces it,"** and hostname-based admission ≠ content inspection — pair it with a [data boundary policy](./data-boundary-policy.mdx) to actually stop exfiltration.
