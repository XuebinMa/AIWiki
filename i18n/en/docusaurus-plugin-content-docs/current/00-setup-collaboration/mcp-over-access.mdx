...
<PitfallMeta roles={['DevOps Engineer', 'Architect', 'Engineer']} phase="Setup & Collaboration" severity="High" appliesTo="All models (including Claude Code)" evidence="Security advisory" />
...
flowchart LR
    ...
    B --> C{Do I hold a<br/>high-privilege MCP tool?<br/>&nbsp;}
