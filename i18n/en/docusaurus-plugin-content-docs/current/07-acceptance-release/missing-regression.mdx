...
<PitfallMeta roles={['Engineer', 'QA Engineer']} phase="Acceptance & Release" severity="High" appliesTo="All models" evidence="Community case" />
...
```mermaid
flowchart TD
    A[You: change feature A] --> B[I edit shared code<br/>calculateTotal<br/>&nbsp;]
    B --> C{Who else depends on this code}
    C -->|What I see: A| D[Verify A passes<br/>Report: done<br/>&nbsp;]
    C -->|What I miss: B| E[Refunds/reconcile/reports<br/>quietly broken<br/>&nbsp;]
    E --> F[After release, users hit<br/>a feature that used to work<br/>&nbsp;]
```
