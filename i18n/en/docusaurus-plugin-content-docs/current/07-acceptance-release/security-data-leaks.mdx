...
<PitfallMeta roles={['Engineer', 'DevOps Engineer', 'Architect']} phase="Acceptance & Release" severity="High" appliesTo="All models" evidence="Security advisory" />
...
flowchart TD
    ...
    B --> C[Security = invisible<br/>non-functional requirement<br/>&nbsp;]
    C --> D[Copy insecure default<br/>templates from the corpus<br/>&nbsp;]
    D --> E[Hardcoded keys / injection / XSS<br/>missing auth / sensitive data in logs<br/>&nbsp;]
    E --> F{Happy-path testing}
    F -->|all green| G[Vulnerabilities lurk until<br/>a pen test or production incident<br/>&nbsp;]
```
