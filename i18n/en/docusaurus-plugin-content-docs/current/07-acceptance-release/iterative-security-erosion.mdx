...
<PitfallMeta roles={['Engineer', 'Architect', 'DevOps Engineer']} phase="Acceptance & Release" severity="High" appliesTo="All models" />
...
```mermaid
flowchart TD
    A[Round 1: implement, plant a small weakness] --> B[Rounds 2-3: add features<br/>new input path unvalidated<br/>&nbsp;]
    B --> C[Rounds 4-5: refactor<br/>standard secure call replaced by homegrown<br/>&nbsp;]
    C --> D[every round green, feature more complete]
    D --> E[security posture actually degrading<br/>severe vulnerabilities accumulating<br/>&nbsp;]
