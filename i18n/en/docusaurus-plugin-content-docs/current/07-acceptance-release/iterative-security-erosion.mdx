...
sidebar_label: "Security erosion across iterations"
...
<PitfallMeta roles={['Engineer', 'Architect', 'DevOps Engineer']} phase="Acceptance & Release" severity="High" appliesTo="All coding agents" evidence="Research" />
