...
<PitfallMeta roles={['Architect', 'Engineer']} phase="Architecture" severity="High" appliesTo="All models" evidence="Community case" />
...
flowchart TD
    ...
    B --> D[I can't see the rationale<br/>can't see the rejected option<br/>&nbsp;]
    D --> E[Re-pitch an already-rejected option]
    D --> F[Violate established layering and patterns]
    E --> G[Things you thought were settled<br/>get reopened by me again and again<br/>&nbsp;]
    F --> G
```
