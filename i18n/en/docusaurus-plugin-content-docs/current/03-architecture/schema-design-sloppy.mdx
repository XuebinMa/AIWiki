...
sidebar_label: "Sloppy schema design"
...
<PitfallMeta roles={['Architect', 'Engineer']} phase="Architecture" severity="High" appliesTo="All coding agents" />
...
flowchart TD
    ...
    C -->|No, looks storable so it passes| D["careless types float-as-money<br/>free text as enum, missing constraints/indexes<br/>no thought to multi-value or future query dimensions"]
