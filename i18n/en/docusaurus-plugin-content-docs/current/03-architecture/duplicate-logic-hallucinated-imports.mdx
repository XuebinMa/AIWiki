...
sidebar_label: "Duplicate logic & hallucinated imports"
...
<PitfallMeta roles={['Architect', 'Engineer']} phase="Architecture" severity="High" appliesTo="All coding agents" evidence="Research" />
...
```mermaid
flowchart TD
    A[You ask for a cross-module / cross-repo change] --> B{I need a symbol<br/>function / module / package}
    ...
    E --> F[Reimplement an existing helper<br/>DRY violation]
    E --> G[Import a non-existent<br/>module / function / package]
