...
<PitfallMeta roles={['Engineer']} phase="Detailed Design" severity="High" appliesTo="All Claude Code versions" evidence="Official docs" />
...
flowchart TD
    ...
    C -->|You didn't mention them, I didn't think of them| D["null / empty collection / out-of-range<br/>size=0 / time zone / encoding<br/>&nbsp;"]
