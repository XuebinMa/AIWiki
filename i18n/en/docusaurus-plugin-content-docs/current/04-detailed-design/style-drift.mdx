...
<PitfallMeta roles={['Engineer']} phase="Detailed Design" severity="Medium" appliesTo="All coding agents" evidence="Official docs" />
...
flowchart TD
    ...
    B -- No --> C[Generate from memory<br/>the statistically common default]
    B -- Yes: read neighboring files --> D[Generate following the repo's existing style]
    C --> E[Looks fine alone<br/>a different accent once combined]
