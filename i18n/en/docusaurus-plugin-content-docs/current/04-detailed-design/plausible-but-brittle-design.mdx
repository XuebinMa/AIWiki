...
flowchart TD
    ...
    C -->|No, it reads fine straight through| D["scale-up / timeout & retry<br/>concurrency & idempotency / partial failure<br/>&nbsp;"]
