...
sidebar_label: "Magic numbers & hardcoding"
...
<PitfallMeta roles={['Engineer']} phase="Detailed design" severity="Medium" appliesTo="All coding agents" evidence="Community case" />
