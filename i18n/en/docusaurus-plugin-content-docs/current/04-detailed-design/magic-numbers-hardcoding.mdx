...
flowchart TD
    ...
    B -- No: fill in a literal --> C[welded in place<br/>no name, no central place, scattered<br/>&nbsp;]
    B -- Yes: distinguish true constant from config value --> D[named constant + inject by environment<br/>single source<br/>&nbsp;]
    C --> E[change one spot, search the whole repo<br/>switch environments and it breaks, read code by guessing<br/>&nbsp;]
