...
sidebar_label: "Concurrency races"
...
<PitfallMeta roles={['Engineer', 'Architect']} phase="Detailed design" severity="High" appliesTo="All coding agents" evidence="Research" />
...
flowchart TD
    ...
    C -->|You didn't mention it, I assume exclusive execution| D["race / lost update<br/>check-then-act non-atomic<br/>no lock no transaction / deadlock"]
