...
sidebar_label: "Underestimating effort"
...
<PitfallMeta roles={['Project Manager', 'Architect', 'Engineer']} phase="Ideation & Feasibility" severity="Medium" appliesTo="All coding agents" evidence="Community case" />
