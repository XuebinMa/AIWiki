...
sidebar_label: "\"Possible\" mistaken for \"feasible\""
...
<PitfallMeta roles={['Project Manager', 'Architect']} phase="Ideation & Feasibility" severity="High" appliesTo="All coding agents" evidence="Community case" />
...
flowchart TD
    ...
    A -. what you actually meant .-> E{Is it feasible under your constraints}
