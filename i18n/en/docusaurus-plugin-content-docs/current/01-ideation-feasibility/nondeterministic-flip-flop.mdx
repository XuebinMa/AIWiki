...
<PitfallMeta roles={['Project Manager', 'Architect', 'Engineer']} phase="Ideation & Feasibility" severity="Medium" appliesTo="All sampling-based chat models (a general trait)" />
...
flowchart TD
    ...
    E --> G[You see only one answer<br/>&nbsp;]
    F --> G
