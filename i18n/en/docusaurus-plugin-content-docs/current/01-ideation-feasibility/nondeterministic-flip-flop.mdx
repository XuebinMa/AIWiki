...
sidebar_label: "Nondeterministic flip-flop"
...
<PitfallMeta roles={['Project Manager', 'Architect', 'Engineer']} phase="Ideation & Feasibility" severity="Medium" appliesTo="All LLMs" evidence="Research" />
