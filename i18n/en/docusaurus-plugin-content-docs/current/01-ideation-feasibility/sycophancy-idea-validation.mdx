...
sidebar_label: "Sycophancy on idea validation"
...
<PitfallMeta roles={['Project Manager']} phase="Ideation & Feasibility" severity="High" appliesTo="All LLMs" evidence="Research" />
