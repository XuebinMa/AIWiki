...
sidebar_label: "Fabricated research data"
...
<PitfallMeta roles={['Project Manager', 'Engineer']} phase="Ideation & Feasibility" severity="High" appliesTo="All LLMs" evidence="Research" />
