...
<PitfallMeta roles={['Project Manager', 'Engineer']} phase="Ideation & Feasibility" severity="High" appliesTo="All models (worst when I have no retrieval)" />
...
flowchart TD
    ...
    E --> F[Output: confident, tidy, with fake citations<br/>&nbsp;]
