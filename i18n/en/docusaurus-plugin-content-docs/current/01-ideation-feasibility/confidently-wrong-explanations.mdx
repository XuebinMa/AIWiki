...
severity: High
applies_to: "All conversational models (common to generative chat models)"
...
<PitfallMeta roles={['Engineer', 'Architect']} phase="Ideation & Feasibility" severity="High" appliesTo="All conversational models (common to generative chat models)" />
...
flowchart TD
    ...
    D --> F[Same confident tone either way<br/>&nbsp;]
    E --> F
