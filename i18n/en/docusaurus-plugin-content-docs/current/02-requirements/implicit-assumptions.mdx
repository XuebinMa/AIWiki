...
sidebar_label: "Filling in unstated assumptions"
...
<PitfallMeta roles={['Project Manager', 'Engineer', 'Architect']} phase="Requirements" severity="High" appliesTo="All coding agents" evidence="Community case" />
