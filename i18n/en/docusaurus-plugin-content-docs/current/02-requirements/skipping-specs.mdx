...
sidebar_label: "Skipping the spec"
slug: skipping-specs
sidebar_position: 5
...
<PitfallMeta roles={['Project Manager', 'Architect', 'Engineer']} phase="Requirements" severity="Medium" appliesTo="All coding agents" evidence="Official docs" />
