...
sidebar_label: "Guessing at a requirements gap"
...
<PitfallMeta roles={['Project Manager', 'Engineer']} phase="Requirements" severity="High" appliesTo="All coding agents" evidence="Community case" />
