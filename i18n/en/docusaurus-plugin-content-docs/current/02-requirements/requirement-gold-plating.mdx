...
sidebar_label: "Requirement gold-plating"
...
<PitfallMeta roles={['Project Manager', 'Engineer']} phase="Requirements" severity="Medium" appliesTo="All coding agents" evidence="Community case" />
