...
flowchart TD
    ...
    D --> E["my assumed dependency response == my implementation<br/>both ends set by me, tautology<br/>&nbsp;"]
    F["real boundaries / error codes / contract changes<br/>never executed, bugs hide here<br/>&nbsp;"]
