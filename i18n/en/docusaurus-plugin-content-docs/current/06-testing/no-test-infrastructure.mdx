...
sidebar_label: "Skipping test infrastructure"
...
<PitfallMeta roles={['Engineer', 'QA Engineer']} phase="Testing" severity="High" appliesTo="All coding agents" evidence="Official docs" />
