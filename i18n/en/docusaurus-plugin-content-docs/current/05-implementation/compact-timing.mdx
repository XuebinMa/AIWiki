...
tags: [context management, compaction, sessions, engineer]
sources:
...
flowchart TD
    ...
    B --> C["Structured summary<br/>keeps: intent / key concepts / files modified<br/>drops: full tool output / intermediate reasoning<br/>&nbsp;"]
