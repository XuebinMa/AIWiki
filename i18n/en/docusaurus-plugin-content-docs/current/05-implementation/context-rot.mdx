...
<PitfallMeta roles={['Engineer', 'Architect']} phase="Implementation" severity="Medium" appliesTo="All models" evidence="Research" />
...
flowchart LR
    ...
    B["info in the middle<br/>thinnest attention<br/>&nbsp;"] --> H["easily missed / misused"]
    C["info at the end"] --> G
    D["very long context<br/>(even if all relevant)<br/>&nbsp;"] --> H
```
