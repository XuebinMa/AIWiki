...
<PitfallMeta roles={['Engineer']} phase="Implementation" severity="Medium" appliesTo="All Claude Code versions" evidence="Research" />
...
flowchart TD
    ...
    E --> F[the comment becomes a fossil<br/>&nbsp;]
