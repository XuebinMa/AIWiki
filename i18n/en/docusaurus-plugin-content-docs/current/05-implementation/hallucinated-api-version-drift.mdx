...
<PitfallMeta roles={['Engineer', 'Architect']} phase="Implementation" severity="High" appliesTo="All models" evidence="Official docs" />
...
flowchart TD
    ...
    C --> D["Old API / mixed versions / hallucinated method<br/>all of it looks right<br/>&nbsp;"]
