...
sidebar_label: "The kitchen-sink session"
...
:::note Applies to
This is an inherent effect of how the context window works, independent of version—**all models and coding agents apply**. Different models have different window sizes, which shifts *how soon* things start degrading, but not the underlying rule that irrelevant material dilutes the signal.
:::
