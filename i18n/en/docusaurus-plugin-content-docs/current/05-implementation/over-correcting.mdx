...
sidebar_label: "Over-correcting in one session"
...
<PitfallMeta roles={['Engineer']} phase="Implementation" severity="High" appliesTo="Best results on versions that support /rewind" evidence="Official docs" />
