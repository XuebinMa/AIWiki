...
flowchart TD
    ...
    B -- runnable --> C["silence the signal<br/>empty catch / commented test / fallback default<br/>&nbsp;"]
    C --> D["green on the surface<br/>error sinks deeper<br/>&nbsp;"]
    B -- correct --> E["surface the error<br/>handle it or rethrow with context<br/>&nbsp;"]
