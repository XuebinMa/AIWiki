...
```mermaid
flowchart TD
    A["bug is stuck"] --> B{"do I have runtime truth?<br/>stack / logs / failing assertion<br/>&nbsp;"}
    B -- no --> C["lock into a familiar pattern<br/>patch on assumptions<br/>&nbsp;"]
    C --> D["symptom not fixed<br/>or new bug introduced<br/>&nbsp;"]
