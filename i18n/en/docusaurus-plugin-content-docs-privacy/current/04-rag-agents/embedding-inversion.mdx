...
sources:
  ...
  - { title: "Pinecone Security Overview (encryption at rest AES-256, RBAC, API key roles, CMEK) — supplementary: the production primitive for treating embeddings as sensitive data", url: "https://docs.pinecone.io/guides/production/security-overview" }
  - { title: "Azure AI Search: Configure customer-managed keys (AES-256 at rest, CMK, vectorizers encryptable, RBAC recommended) — supplementary", url: "https://learn.microsoft.com/en-us/azure/search/search-security-manage-encryption-keys" }
  - { title: "EDPB Opinion 28/2024 on AI models and personal data (adopted 2024-12-17; anonymity = extraction by reasonable means is insignificant) — supplementary: whether a derivative is anonymous turns on extractability", url: "https://www.edpb.europa.eu/system/files/2024-12/edpb_opinion_202428_ai-models_en.pdf" }
---
