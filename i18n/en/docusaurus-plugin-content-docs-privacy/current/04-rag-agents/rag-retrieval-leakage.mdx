...
<PrivacyMeta era="Volume 4 · RAG and agents" technique="RAG & agent privacy" audience={['Privacy Engineer', 'Security Engineer', 'ML Engineer']} severity="High" maturity="Experimental" evidence="Research" />
...
Mixed evidence — **primary: Research** (embedding inversion); **supplementary: official incident** (OpenAI outage), **framework** (OWASP).
