...
- **DP is the most mainstream, most general, most composable formal defense framework — but watch ε.** DP gives a provable bound, but with ε too large the bound is vacuous; and it has a utility cost (see DP fine-tuning).
