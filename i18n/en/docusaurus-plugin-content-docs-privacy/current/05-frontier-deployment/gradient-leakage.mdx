...
- **Differential privacy**: **clip + add noise** to gradients, bounding single-sample influence within (ε, δ), and inversion quality collapses (see [DP fine-tuning](../03-conversational-llms/dp-fine-tuning.mdx) and *Production-grade DP·FL*).
