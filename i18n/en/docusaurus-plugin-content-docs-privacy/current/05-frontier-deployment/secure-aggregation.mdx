...
2. Set the threshold and dropout tolerance right: threshold t decides "how many must
   collude to break" and "how many dropouts still recover" — tune to your participation
...
5. Audit two things: (1) the server implementation really can't get individual updates;
   ...
   update isn't recoverable within the threshold assumption.
```
