...
In ordinary fine-tuning, how much a single sample can "tug" my parameters has, in principle, no ceiling — one extreme, distinctive sample can leave an **externally detectable imprint** on me (this is the shared root of memorization, extraction, and membership inference).
