...
> **Wave 1 已落 5 条**（子代理并行起草 + 主控质量过）：嵌入反演、隐私定向投毒、属性 / 分布推断、遗忘可验证性、推理期侧信道。下表余 6 条（合成数据隐私 / LLM 水印 / 拆分学习 / 联邦分析 / FTaaS / AgentDojo）待后续 wave。
