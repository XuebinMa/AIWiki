...
evidence: 研究支持
tags: [验证闭环, 测试, 信任但不验证, 工程师, 测试工程师, Codex CLI, Cursor, GitHub Copilot]
sources:
...
- **Claude Code**：hooks（工具调用后 / 会话停止等挂点）把跑测试、格式化、拦截做成**确定性步骤**——测试结果直接来自钩子，不经我转述。
