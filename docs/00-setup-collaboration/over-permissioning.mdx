...
evidence: 官方文档
tags: [权限, 最小权限, 安全, 提示注入, 运维工程师, 工程师, Gemini CLI, Codex CLI, Cursor, GitHub Copilot]
sources:
  ...
  - { title: "Gemini CLI — approval modes / configuration（官方文档）", url: "https://github.com/google-gemini/gemini-cli/blob/main/docs/get-started/configuration.md" }
...
<PitfallMeta roles={['运维工程师', '工程师']} phase="准备与协作" severity="高" appliesTo="Coding Agent 通用" evidence="官方文档" />
