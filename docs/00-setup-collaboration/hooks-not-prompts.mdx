...
<PitfallMeta roles={['工程师', '运维工程师']} phase="准备与协作" severity="高" appliesTo="Claude Code 全版本" />
...
flowchart TB
    subgraph P[写进提示词 / CLAUDE.md]
        P1["进入上下文窗口"] --> P2["我概率性遵守<br/>会忘 / 会漂 / 压缩后丢失<br/>&nbsp;"]
    end
    subgraph H[做成 hook]
        H1["harness 在固定节点触发"] --> H2["确定性执行<br/>不经过我的判断<br/>&nbsp;"]
    end
