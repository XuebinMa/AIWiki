...
<PitfallMeta roles={['工程师']} phase="编码实现" severity="高" appliesTo="Claude Code 全版本" />
...
flowchart TD
    ...
    B -- 可运行 --> C["压住信号<br/>空 catch / 注释测试 / 兜底默认<br/>&nbsp;"]
    C --> D["表面变绿<br/>错误潜入更深处<br/>&nbsp;"]
    B -- 正确 --> E["让错误浮出<br/>处理或带上下文重抛<br/>&nbsp;"]
    E --> F["真实信号到你手上"]
```
